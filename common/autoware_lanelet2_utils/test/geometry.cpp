...
TEST(LineStringTest, InterpolateLineStringFromFirst) {
  ...
  lanelet::ConstLineString3d interp_line = lanelet2_utils::interpolate_linestring(line, s, from_first);
...
TEST(LineStringTest, ExtrapolateLineStringForward) {
  ...
  lanelet::ConstLineString3d extra_line = lanelet2_utils::extrapolate_linestring(line, dist, is_forward);
